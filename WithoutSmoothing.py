...
class BIOnBijan:
    ...
    def Bigram_Score(self):
        ...
        bigramWAddOne = self.calcBigramProb()
        ...
        for i in range(len(bigSeq)):
            if bigSeq[i] in self.listOfBigrams:
                probTest = probTest*bigramWAddOne[bigSeq[i]]
